...
for file_num in tqdm(range(0, 51)):
   ...
   if file_num == 0:
      ax.set_ylabel(r'$\log_{10}[L^{-1}P(k)]$', fontsize=18)
   ...
   # if file_num == 0:
   #    left, bottom, width, height = [0.275, 0.675, 0.175, 0.175]
   # elif file_num == 50:
   #    left, bottom, width, height = [0.24, 0.25, 0.175, 0.175]
   # else:
   #    pass
   ...
   # # plt.show()
   plt.savefig(f'../plots/paper_plots_final/PS/PS_{file_num}.png', bbox_inches='tight', dpi=300)
   plt.close()